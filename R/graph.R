...
create_graph <- function(splines = "ortho", layout = "neato", outputorder = "edgesfirst", verbose = FALSE){
  graphInput <- sprintf("splines = %s, layout = %s, outputorder = %s", splines, layout, outputorder)
